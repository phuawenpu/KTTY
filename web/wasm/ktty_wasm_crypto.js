 ...
 * @returns {Uint8Array}
 */
export function computeHmac(argon2_key, data) {
    const ptr0 = passArray8ToWasm0(argon2_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.computeHmac(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
export function deriveKey(pin) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.deriveKey(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Uint8Array}
 */
export function mlkemEncapsulate(ek_bytes) {
    const ptr0 = passArray8ToWasm0(ek_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.mlkemEncapsulate(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {string}
 */
export function roomId(derived_key) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(derived_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.roomId(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {boolean}
 */
export function verifyHmac(argon2_key, data, expected) {
    const ptr0 = passArray8ToWasm0(argon2_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.verifyHmac(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ktty_wasm_crypto_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ktty_wasm_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
